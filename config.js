...
module.exports = {
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By suni-annan' : process.env.ALL_CAPTION,
    ...
    OWNERSHIP: process.env.OWNER_SHIP === undefined ? 'suni-annan' : process.env.OWNER_SHIP,
